    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            GridLayout {
                ...
                Repeater {
                    model: [
                        { "title": "Total Tests",  "value": "0", "accent": "#dbeafe", "textColor": "#2563eb", "iconText": "T" },
                        { "title": "Passed",       "value": "0", "accent": "#dcfce7", "textColor": "#16a34a", "iconText": "P" },
                        { "title": "Failed",       "value": "0", "accent": "#fee2e2", "textColor": "#dc2626", "iconText": "F" },
                        { "title": "Success Rate", "value": "-", "accent": "#f3e8ff", "textColor": "#9333ea", "iconText": "%" }
                    ]
                ...
                contentItem: ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            Label {
                                text: "No active result set loaded"
                                color: "#334155"
                                font.pixelSize: 13
                                font.bold: true
                            }
                            ...
                            ColumnLayout {
                                ...
                                Item {
                                    ...
                                    Column {
                                        ...
                                        Label {
                                            width: parent.width
                                            text: "Load a circuit configuration to display pin names, functions, types, and descriptions."
                                            wrapMode: Text.WordWrap
                                            horizontalAlignment: Text.AlignHCenter
                                            color: "#64748b"
                                            font.pixelSize: 13
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            ...
                            ColumnLayout {
                                ...
                                Label {
                                    text: "Run a test to generate a readable summary here. This section can later show pass/fail highlights, warnings, and a short explanation of what happened."
                                    wrapMode: Text.WordWrap
                                    Layout.fillWidth: true
                                    color: "#64748b"
                                    font.pixelSize: 13
    ...
    FileDialog {
        ...
        onAccepted: {
            ...
            if (selectedPath.startsWith("file:///")) {
                selectedPath = decodeURIComponent(selectedPath.substring(8))
            } else if (selectedPath.startsWith("file://")) {
                selectedPath = decodeURIComponent(selectedPath.substring(7))
            }
